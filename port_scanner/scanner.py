...
# Define a list of vulnerable ports
vulnerable_ports = [137, 139, 445, 22, 53, 25, 3389, 80, 443, 8080, 8443, 20, 21, 23, 1433, 1434, 3306]
...
def scan_ports(target_ip, port):
    ...
    try:
        ...
        if result == 0:
            ...
            # Check if the scanned port is in the list of vulnerable ports
